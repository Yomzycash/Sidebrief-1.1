  ...
  return (
    <Wrapper>
      <Container>
        ...
        <Number>{status?.all}</Number>
        <TextWrapper>
          <StatusWrapper>All Business Registrations</StatusWrapper>
        </TextWrapper>
      </Container>
      ...
      <Container>
        ...
        <TextWrapper>
          <StatusWrapper>Businesses Submitted</StatusWrapper>
        </TextWrapper>
      </Container>
      ...
      <Container>
        ...
        <TextWrapper>
          <StatusWrapper>Business Drafts</StatusWrapper>
        </TextWrapper>
      </Container>
