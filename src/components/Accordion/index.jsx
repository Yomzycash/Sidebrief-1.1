...
const Accordion = ({ name, type, country, date, code, countryISO, navigate,product, action, url,   }) => {
  const launchInfo = {
    launchCode: code,
    ...
    <Wrapper>
      ...
      {isActive && (
        <AllContentWrapper>
          <ContentWrapper>
            <SubContentWrapper>
              {/* {content && <ContentTitle>{content? 'Type' : 'Status'}</ContentTitle>} */}
              <ContentTitle>{content? 'Type' : 'Status'}</ContentTitle>
              <SubWrapper>
                {/* {type && <ContentTitle>{type}</ContentTitle> } */}
          ...
          {/* {!product ? 
            <Details onClick={() => navigate(url)}>More details</Details>
          ...
          {/* {!product && 
            ...
            <Details onClick={!product ? () => navigate(launchInfo) : () => { navigate(url) }}>More details</Details>
