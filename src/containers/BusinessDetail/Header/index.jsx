...
export const Header = ({ isStaff }) => {
	...
	const navigateToMessages = () => {
		if (isStaff) {
			navigate(
				`/staff-dashboard/businesses/services/chats/?serviceId=${code}`
			);
		} else {
		...
		<Container>
			...
			>
				...
				<ActiveNav
					...
					path={`/${
						isStaff ? "staff-dashboard" : "dashboard"
					}/business/shareholders?launchCode=${
						launchResponse.launchCode
					}&registrationCountry=${
						launchResponse.registrationCountry
					}&registrationType=${launchResponse.registrationType}`}
				...
				<ActiveNav
					...
					path={`/${
						isStaff ? "staff-dashboard" : "dashboard"
					}/business/beneficiaries?launchCode=${
						launchResponse.launchCode
					}&registrationCountry=${
						launchResponse.registrationCountry
					}&registrationType=${launchResponse.registrationType}`}
