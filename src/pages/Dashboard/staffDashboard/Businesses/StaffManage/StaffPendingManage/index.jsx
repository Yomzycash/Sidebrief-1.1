...
const StaffPendingManage = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/staff-dashboard/businesses/manage/submitted-manage/${complyCode}/info`);
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => { navigate(`/staff-dashboard/businesses/manage/submitted-manage/${element?.complyCode}/info`)}}
                />
              );
            })}
          </MobileContainer>
...
export default StaffPendingManage;
