...
const StaffPendingOnboarded = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/staff-dashboard/businesses/onboard/submitted-onboard/${complyCode}/info`);
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                    ...
                    action={() => { navigate(`/staff-dashboard/businesses/onboard/submitted-onboard/${element?.complyCode}/info`)}} 
                />
              );
            })}
          </MobileContainer>
...
export default StaffPendingOnboarded;
