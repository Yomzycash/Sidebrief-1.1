...
const StaffPendingTaxes = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/staff-dashboard/businesses/tax/submitted-taxes/${complyCode}/info`);
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => { navigate(`/staff-dashboard/businesses/tax/submitted-taxes/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
...
export default StaffPendingTaxes;
