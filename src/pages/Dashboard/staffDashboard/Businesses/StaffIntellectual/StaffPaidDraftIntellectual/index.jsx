...
const StaffPaidDraftIntellectuals = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(
      `/staff-dashboard/businesses/intellectual-property/paid-draft-intellectual-properties/${complyCode}/info`
    );
  };
...
export default StaffPaidDraftIntellectuals;
