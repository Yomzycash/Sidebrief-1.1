...
const StaffAllIntellectuals = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(
      `/staff-dashboard/businesses/intellectual-property/all-intellectual-properties/${complyCode}/info`
    );
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => { navigate(`/staff-dashboard/businesses/intellectual-property/all-intellectual-properties/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
...
export default StaffAllIntellectuals;
