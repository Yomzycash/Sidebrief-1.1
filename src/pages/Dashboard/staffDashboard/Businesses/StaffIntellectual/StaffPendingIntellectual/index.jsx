...
const StaffPendingIntellectuals = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(
      `/staff-dashboard/businesses/intellectual-property/submitted-intellectual-properties/${complyCode}/info`
    );
  };
          ...
          <MobileContainer>
            {dataArr.map((element) => {
              return (
                ...
                action={() => { navigate(`/staff-dashboard/businesses/intellectual-property/submitted-intellectual-properties/${element?.complyCode}/info`)}}
            />
              );
            })}
          </MobileContainer>
