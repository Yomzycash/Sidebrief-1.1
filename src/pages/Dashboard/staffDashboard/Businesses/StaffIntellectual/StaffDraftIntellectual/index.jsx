...
const StaffDraftIntellectuals = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(
      `/staff-dashboard/businesses/intellectual-property/draft-intellectual-properties/${complyCode}/info`
    );
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => { navigate(`/staff-dashboard/businesses/intellectual-property/draft-intellectual-properties/${element?.complyCode}/info`)}}
            />
              );
            })}
          </MobileContainer>
...
export default StaffDraftIntellectuals;
