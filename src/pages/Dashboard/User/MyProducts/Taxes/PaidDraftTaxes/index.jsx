...
const PaidDraftTaxes = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/tax/paid-draft-taxes/${complyCode}/info`);
  };
          ...
          <MobileContainer>
            {dataArr.map((element) => {
              return (
                ...
                action={()=>{ navigate(`/dashboard/my-products/tax/paid-draft-taxes/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
