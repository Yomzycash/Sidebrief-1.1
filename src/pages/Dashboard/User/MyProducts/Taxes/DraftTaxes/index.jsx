...
const DraftTaxes = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/tax/draft-taxes/${complyCode}/info`);
  };
          ...
          <MobileContainer>
            {dataArr.map((element) => {
              return (
                ...
                action={()=>{ navigate(`/dashboard/my-products/tax/draft-taxes/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
