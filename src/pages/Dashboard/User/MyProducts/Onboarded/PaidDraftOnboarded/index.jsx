...
const PaidDraftOnboarded = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/onboard/paid-draft-onboard/${complyCode}/info`);
  };
          ...
          <MobileContainer>
            {dataArr.map((element) => {
              return (
                ...
                action={()=>{ navigate(`/dashboard/my-products/compliance/paid-draft-onboard/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
