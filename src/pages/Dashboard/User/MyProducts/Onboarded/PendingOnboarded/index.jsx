...
const PendingOnboarded = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/onboard/submitted-onboard/${complyCode}/info`);
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => {
                    navigate(
                      `/dashboard/my-products/compliance/submitted-onboard/${element?.complyCode}/info`
                    );
                  }}
                />
              );
...
export default PendingOnboarded;
