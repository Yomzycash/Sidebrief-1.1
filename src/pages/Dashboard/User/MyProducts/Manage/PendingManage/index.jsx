...
const PendingManage = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/manage/submitted-manage/${complyCode}/info`);
  };
            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={()=>{ navigate(`/dashboard/my-products/manage/submitted-manage/${element?.complyCode}/info`)}}
                />
              );
            })}
          </MobileContainer>
