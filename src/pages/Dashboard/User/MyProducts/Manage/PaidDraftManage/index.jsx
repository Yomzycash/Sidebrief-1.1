...
const PaidDraftManage = () => {
  ...
  const handleRowClick = (el) => {
    ...
    navigate(`/dashboard/my-products/manage/paid-draft-manage/${complyCode}/info`);
  };
          ...
          <MobileContainer>
            {dataArr.map((element) => {
              return (
                ...
                action={()=>{ navigate(`/dashboard/my-products/manage/paid-draft-manage/${element?.complyCode}/info`)}}
              />
              );
            })}
          </MobileContainer>
...
export default PaidDraftManage;
