            ...
            {dataArr.map((element) => {
              return (
                <Accordion
                  ...
                  action={() => {
                    navigate(
                      `/dashboard/my-products/intellectual-property/submitted-intellectual-properties/${element?.complyCode}/info`
                    );
                  }}
                />
              );
...
export default PendingIntellectuals;
